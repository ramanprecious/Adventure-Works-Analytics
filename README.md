...
## PROJECT THREE - [Adventure Works Analysis](https://github.com/ramanprecious/Data-Analyst-Portfolio-PowerBI/tree/main/Adventure%20Works%20Analytics)
...
As the world becomes technologically advanced, Adventure Works stakeholders have decided to increase productivity and profitability by employing the use of data in making accurate decisions and building strategies.
...
1. More sales were recorded in the United States. This is a result of the huge online presence Adventure Works have in this country which is its original location. More online marketing stategies should be employed to generate more orders.
2. Higher sales occured in 2022, compared to 2021 and 2020. This could be a result of the Covid-19 pandemic or introduction of new business development stategies. There is a need for the finetuning of current marketing strategies to improve optimization.
3. The bike product category generated more sales and profit. Mountain bikes brand made highest sales while Road bike brand made the highest profit. More bikes should be introduced in the stock.
...
7. More profit was generated from the bike category in Australia. Australians seem to love using bikes and this is evident in the dasnboard.
